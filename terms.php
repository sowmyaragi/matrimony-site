  ...
  <div class="container">
   ...
   <div class="terms_1">
	    ...
	    <ul class="feature_list">
			<li><a href="#">1. There are many variations of passages of Recently Coupled Pairs available.</a></li>
			...
			<li><a href="#">7. Team Menber.</a></li>
		</ul>
	    <h5>On the other hand, we denounce with righteous indignation and dislike </h5>   
	    <ul class="feature_list feature_list1">
			<li><a href="#">There are many variations of passages of Recently Coupled Pairs available.</a></li>
			...
			<li><a href="#">Team Menber.</a></li>
		</ul>
		<p>"Team Menber, consectetur adipiscing elit, sed do Sowmya ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur Alekhya cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."</p>
		<p>"At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi Alekhyai cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio.</p>
