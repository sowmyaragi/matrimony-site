   ...
   <div class="about">
   	  ...
   	  <div class="col-md-6 about_right">
		   ...
		   <div class="jb-accordion-wrapper">
				...
				<p>This website is a beautiful website that is user friendly.. As a result, whether it is youngsters or the elderly in the family, anyone can access these websites easily</p>
				</div>
				<p><!-- /.collapse --></p>
			</div>
			<div class="jb-accordion-wrapper">
	  ...
	  <div class="about_middle-grid1">
		<div class="col-sm-6 testi_grid list-item-0">
			<blockquote class="testi_grid_blockquote">
				...
				<div><a href="#">we are happy by using this website :-) </a>
				<div class="clearfix"></div>
				</div>
			</blockquote>
		    <small class="testi-meta"><span class="user">Sowmya</span></small>
		</div>
		<div class="col-sm-6 testi_grid list-item-1">
			...
			<small class="testi-meta1"><span class="user">Alekhya </span></small>
		</div>
		<div class="clearfix"> </div>
	  </div>
